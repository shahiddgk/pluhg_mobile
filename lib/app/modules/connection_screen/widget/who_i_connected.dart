              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      height: 28.h,
                      margin: EdgeInsets.only(top: 12.0.h, left: 24.0.w, right: 24.0.w, bottom: 12.h),
                      decoration: BoxDecoration(
                          color: data["isRequesterAccepted"] && data["isContactAccepted"]
                              ? Color(0xff18C424)
                              : Color(0xffBFA124),
                          borderRadius: BorderRadius.circular(28)),
                      child: Center(
                          child: Text(data["isRequesterAccepted"] && data["isContactAccepted"] ? "Accepted" : "Pending",
