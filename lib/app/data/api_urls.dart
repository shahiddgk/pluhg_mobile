class ApplicationURLs {
  static const BASE_URL = "https://api.pluhg.com/api/";//"http://192.168.31.86:8000/api/";
  static const WS_URL = "ws://api.pluhg.com"; //"ws://192.168.31.86:8000";
  ...
  static const API_GET_NOTIFICATION_SETTINGS = BASE_URL + "notification/settings";
  static const API_GET_RECOMMENDED_CONNECTIONS = BASE_URL + "connect/whoIconnected";
  static const API_GET_ACTIVE_CONNECTIONS = BASE_URL + "connect/activeConnections";
  static const API_GET_WAITING_CONNECTIONS = BASE_URL + "connect/waitingConnections";
  ...
  static const API_GET_CONNECTION_DETAILS = BASE_URL + "connect/getConnectionsDetails/";
  ...
  static const API_UPDATE_NOTFICATION_SETTINGS = BASE_URL + "notification/settings/update";
